...
module nios_setup_v2_mm_interconnect_0 (
	...
	wire  [11:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> button_s1_agent:cp_channel
	...
	wire  [95:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> switch_s1_agent:cp_data
	...
	wire  [95:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> led_s1_agent:cp_data
	...
	wire  [11:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> hex0_s1_agent:cp_channel
	...
	wire  [95:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> hex5_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // hex5_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [11:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> hex5_s1_agent:cp_channel
	...
	wire  [95:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> hex2_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                     // hex2_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [11:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> hex2_s1_agent:cp_channel
	...
	wire  [95:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> hex1_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                     // hex1_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [11:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> hex1_s1_agent:cp_channel
	...
	wire  [95:0] switch_s1_agent_rp_data;                                                   // switch_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [95:0] led_s1_agent_rp_data;                                                      // led_s1_agent:rp_data -> router_008:sink_data
	...
	wire         hex5_s1_agent_rp_valid;                                                    // hex5_s1_agent:rp_valid -> router_010:sink_valid
	wire  [95:0] hex5_s1_agent_rp_data;                                                     // hex5_s1_agent:rp_data -> router_010:sink_data
	wire         hex5_s1_agent_rp_ready;                                                    // router_010:sink_ready -> hex5_s1_agent:rp_ready
	wire         hex5_s1_agent_rp_startofpacket;                                            // hex5_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         hex5_s1_agent_rp_endofpacket;                                              // hex5_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire  [95:0] hex2_s1_agent_rp_data;                                                     // hex2_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [95:0] hex1_s1_agent_rp_data;                                                     // hex1_s1_agent:rp_data -> router_013:sink_data
	...
	wire         hex5_s1_agent_rdata_fifo_src_valid;                                        // hex5_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] hex5_s1_agent_rdata_fifo_src_data;                                         // hex5_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         hex5_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_008:in_0_ready -> hex5_s1_agent:rdata_fifo_src_ready
	...
	nios_setup_v2_mm_interconnect_0_router_002 router_003 (
	...
	nios_setup_v2_mm_interconnect_0_router_004 router_004 (
	...
	nios_setup_v2_mm_interconnect_0_router_004 router_005 (
	...
	nios_setup_v2_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_setup_v2_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_setup_v2_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
